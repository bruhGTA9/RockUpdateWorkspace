...
public class ZapphireOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:zapphire_ore")
	public static final Block block = null;
	public ZapphireOreBlock(RockupdateModElements instance) {
		super(instance, 15);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("zapphire_ore", "zapphire_ore", blockAt -> {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 0, 0, 38))));
		}
	}
}
