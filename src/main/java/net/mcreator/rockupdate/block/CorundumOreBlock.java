...
import net.mcreator.rockupdate.item.CorundumItem;
...
public class CorundumOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:corundum_ore")
	public static final Block block = null;
	public CorundumOreBlock(RockupdateModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CorundumItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("corundum_ore", "corundum_ore", blockAt -> {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(3, 0, 0, 25))));
		}
	}
}
