...
public class AmazoniteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:amazonite_ore")
	public static final Block block = null;
	public AmazoniteOreBlock(RockupdateModElements instance) {
		super(instance, 7);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("amazonite_ore", "amazonite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 4)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 0, 0, 29))));
		}
	}
}
