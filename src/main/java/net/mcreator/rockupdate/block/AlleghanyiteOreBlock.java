...
import net.mcreator.rockupdate.item.AlleghanyiteItem;
...
public class AlleghanyiteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:alleghanyite_ore")
	public static final Block block = null;
	public AlleghanyiteOreBlock(RockupdateModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("alleghanyite_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AlleghanyiteItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("alleghanyite_ore", "alleghanyite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 4)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(3, 1, 1, 39))));
		}
	}
}
