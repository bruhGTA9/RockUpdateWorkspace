...
public class WhiteStoneBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:white_stone")
	public static final Block block = null;
	public WhiteStoneBlock(RockupdateModElements instance) {
		super(instance, 17);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("white_stone", "white_stone", blockAt -> {
			...
			}), block.getDefaultState(), 15)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(17, 0, 0, 59))));
		}
	}
}
