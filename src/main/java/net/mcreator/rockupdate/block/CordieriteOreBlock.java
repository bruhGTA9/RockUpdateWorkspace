...
public class CordieriteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:cordierite_ore")
	public static final Block block = null;
	public CordieriteOreBlock(RockupdateModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cordierite_ore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("cordierite_ore", "cordierite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 0, 0, 24))));
		}
	}
}
