...
public class CobaltOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:cobalt_ore")
	public static final Block block = null;
	public CobaltOreBlock(RockupdateModElements instance) {
		super(instance, 6);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 0, 0, 37))));
		}
	}
}
