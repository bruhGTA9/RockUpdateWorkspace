...
public class JasperOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:jasper_ore")
	public static final Block block = null;
	public JasperOreBlock(RockupdateModElements instance) {
		super(instance, 37);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("jasper_ore", "jasper_ore", blockAt -> {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(3, 0, 0, 16))));
		}
	}
}
