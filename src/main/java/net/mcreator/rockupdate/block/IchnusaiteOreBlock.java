...
public class IchnusaiteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:ichnusaite_ore")
	public static final Block block = null;
	public IchnusaiteOreBlock(RockupdateModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ichnusaite_ore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ichnusaite_ore", "ichnusaite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 2)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 0, 0, 46))));
		}
	}
}
