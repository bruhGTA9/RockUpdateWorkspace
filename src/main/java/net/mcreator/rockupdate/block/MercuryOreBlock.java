...
public class MercuryOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:mercury_ore")
	public static final Block block = null;
	public MercuryOreBlock(RockupdateModElements instance) {
		super(instance, 8);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("mercury_ore", "mercury_ore", blockAt -> {
			...
			}), block.getDefaultState(), 4)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(5, 0, 0, 38))));
		}
	}
}
