...
public class GaspeiteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:gaspeite_ore")
	public static final Block block = null;
	public GaspeiteOreBlock(RockupdateModElements instance) {
		super(instance, 35);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("gaspeite_ore", "gaspeite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 0, 0, 40))));
		}
	}
}
