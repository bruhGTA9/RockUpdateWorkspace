...
public class PeridotOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:peridot_ore")
	public static final Block block = null;
	public PeridotOreBlock(RockupdateModElements instance) {
		super(instance, 39);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("peridot_ore", "peridot_ore", blockAt -> {
			...
			}), block.getDefaultState(), 4)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(3, 0, 0, 36))));
		}
	}
}
