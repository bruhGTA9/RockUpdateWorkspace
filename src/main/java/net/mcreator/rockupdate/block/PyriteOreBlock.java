...
public class PyriteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:pyrite_ore")
	public static final Block block = null;
	public PyriteOreBlock(RockupdateModElements instance) {
		super(instance, 20);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("pyrite_ore", "pyrite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 8)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 0, 0, 42))));
		}
	}
}
