...
import net.mcreator.rockupdate.item.GarnetItem;
...
public class GarnetOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:garnet_ore")
	public static final Block block = null;
	public GarnetOreBlock(RockupdateModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GarnetItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("garnet_ore", "garnet_ore", blockAt -> {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 0, 0, 32))));
		}
	}
}
