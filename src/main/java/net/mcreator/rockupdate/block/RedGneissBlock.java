...
public class RedGneissBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:red_gneiss")
	public static final Block block = null;
	public RedGneissBlock(RockupdateModElements instance) {
		super(instance, 21);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("red_gneiss", "red_gneiss", blockAt -> {
			...
			}), block.getDefaultState(), 18)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(17, 0, 0, 28))));
		}
	}
}
