...
public class BustamiteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:bustamite_ore")
	public static final Block block = null;
	public BustamiteOreBlock(RockupdateModElements instance) {
		super(instance, 27);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("bustamite_ore", "bustamite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(5, 0, 0, 28))));
		}
	}
}
