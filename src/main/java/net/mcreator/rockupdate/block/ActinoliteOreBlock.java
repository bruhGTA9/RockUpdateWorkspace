...
public class ActinoliteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:actinolite_ore")
	public static final Block block = null;
	public ActinoliteOreBlock(RockupdateModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("actinolite_ore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("actinolite_ore", "actinolite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 0, 0, 53))));
		}
	}
}
