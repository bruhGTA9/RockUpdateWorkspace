...
public class CopperOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(RockupdateModElements instance) {
		super(instance, 12);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 8)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(11, 0, 0, 48))));
		}
	}
}
