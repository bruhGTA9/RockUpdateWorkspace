...
public class CelestineOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:celestine_ore")
	public static final Block block = null;
	public CelestineOreBlock(RockupdateModElements instance) {
		super(instance, 28);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("celestine_ore", "celestine_ore", blockAt -> {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 0, 0, 21))));
		}
	}
}
