...
public class OpalOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:opal_ore")
	public static final Block block = null;
	public OpalOreBlock(RockupdateModElements instance) {
		super(instance, 2);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 2)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(3, 0, 0, 34))));
		}
	}
}
