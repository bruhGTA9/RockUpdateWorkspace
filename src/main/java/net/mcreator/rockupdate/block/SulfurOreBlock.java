...
public class SulfurOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:sulfur_ore")
	public static final Block block = null;
	public SulfurOreBlock(RockupdateModElements instance) {
		super(instance, 5);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 11)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(3, 0, 0, 29))));
		}
	}
}
