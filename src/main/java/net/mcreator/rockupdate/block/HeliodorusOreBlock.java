...
public class HeliodorusOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:heliodorus_ore")
	public static final Block block = null;
	public HeliodorusOreBlock(RockupdateModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("heliodorus_ore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("heliodorus_ore", "heliodorus_ore", blockAt -> {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(8, 0, 0, 33))));
		}
	}
}
