...
import net.mcreator.rockupdate.item.RubyItem;
...
public class RubyOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(RockupdateModElements instance) {
		super(instance, 10);
	}
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, new OreFeature(OreFeatureConfig::deserialize) {
				...
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				if (blockAt.getBlock() == Blocks.POLISHED_GRANITE.getDefaultState().getBlock())
					blockCriteria = true;
