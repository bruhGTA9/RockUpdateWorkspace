...
public class CharoiteOreBlock extends RockupdateModElements.ModElement {
	@ObjectHolder("rockupdate:charoite_ore")
	public static final Block block = null;
	public CharoiteOreBlock(RockupdateModElements instance) {
		super(instance, 30);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("charoite_ore", "charoite_ore", blockAt -> {
			...
			}), block.getDefaultState(), 8)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(8, 1, 1, 12))));
		}
	}
}
